    ...
    class ThermalMonitorService : Service(){
        ...
        private fun createNotificationChannel(){
            ...
            val channel = NotificationChannel("channel_id_1","normal notification",NotificationManager.IMPORTANCE_HIGH)
        ...
        override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
            ...
            val notification = builder
                ...
                .setContentIntent(PendingIntent.getActivity(this,0,Intent(this,MainActivity::class.java),
                    PendingIntent.FLAG_IMMUTABLE))      // 设置通知的意图，即点击通知后会执行的动作
        ...
        private fun observeElapsedTime() {
            // 假设您有某种方式来获取 DataCaptureViewModel 的实例
