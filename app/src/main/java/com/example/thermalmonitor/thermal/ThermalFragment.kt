...
class ThermalFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // 创建ThermalAdapter的实例时，传入一个OnItemCheckedChangedListener实例
        // 用于监听列表中的Item的选中状态发生变化的事件
        binding.recyclerViewThermal.adapter =
            ThermalAdapter(viewModel.thermalList.value ?: emptyList(), object :
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // 观察 ThermalViewModel 中的数据变化，当数据更新时通知适配器刷新界面
        ...
        binding.recyclerViewThermal.addOnLayoutChangeListener { _, _, _, _, _, _, _, _, _ ->
